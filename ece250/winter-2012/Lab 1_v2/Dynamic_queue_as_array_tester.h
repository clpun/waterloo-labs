...
class Dynamic_queue_as_array_tester:public Tester< Dynamic_queue_as_array<Type> > {
	using Tester< Dynamic_queue_as_array<Type> >::object;
	using Tester< Dynamic_queue_as_array<Type> >::command;

	public:
		Dynamic_queue_as_array_tester( Dynamic_queue_as_array<Type> *obj = 0 ):Tester< Dynamic_queue_as_array<Type> >( obj ) {
			// empty
		}
...
template <typename Type>
void Dynamic_queue_as_array_tester<Type>::process() {
	if ( command == "size" ) {
		...
		Dynamic_queue_as_array<Type> *new_object = new Dynamic_queue_as_array<Type>();

		*new_object = *(object);

		std::cout << "Okay" << std::endl;

		Dynamic_queue_as_array_tester<Type> tester( new_object );
