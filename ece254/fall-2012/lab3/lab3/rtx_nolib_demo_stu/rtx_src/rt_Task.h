...
#define WAIT_MBX        8
#define WAIT_MUT        9
#define WAIT_MEM        10       /* added in ECE254 lab3                     */

/* Values for newly added dynamic memory pool */
#define NUM_BLKS        4        /* number of blocks in the memory pool      */
#define BLK_SIZE        8        /* number of bytes per memory block         */
...
/* added in lab3, better to put in a separate file. */
