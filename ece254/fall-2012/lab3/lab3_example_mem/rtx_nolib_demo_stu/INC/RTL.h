 ...
 *      NOTE: modfied to complete ECE254 lab3
 *---------------------------------------------------------------------------*/
 ...
 *      Functions Cortex-M
 *---------------------------------------------------------------------------*/
/* struct rl_task_info added in lab3 */
...
/* task sate user level macro added in lab3 */
#define INACTIVE        0
#define READY           1
#define RUNNING         2
#define WAIT_DLY        3
...
/* memory allocator flag macro  added in lab3 */
#define MEM_NOWAIT      0
#define MEM_WAIT        1
...
/* Dynamic Memory Management Functions added for ECE254 lab3*/
extern void     *rt_mem_alloc (U8 flag);
extern OS_RESULT rt_mem_free  (void *ptr);
