...
typedef struct OS_TCB {
  ...
  /* The following variable type is changed from U8 to U32 for lab3          */
...
/* The following two macros are modifed from the original in lab3            */ 
...
typedef struct OS_BM {
  ...
  struct OS_TCB *p_lnk; 		  /* Chain of tasks waiting for memory block */
} *P_BM;
