...
************ Code added **************
102000c6	91fc 0000 0001 	suba.l 		#1,A0
				reverse_string_loop
102000cc	14d0			move.b		(A0),(A2)+
102000ce	91fc 0000 0001	suba.l 		#1,A0
102000d4	b3c8			cmpa		A0,A1
102000d6	66f8			bne			reverse_string_loop
102000d8	14bc 0000		move.b 		#0,(A2)
************ Code added **************
102000dc	6100 ff8c		bsr.w 		out_string
102000e0	6100 ff72		bsr.w 		out_crlf
* Exit
